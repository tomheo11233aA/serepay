        ...
        <PaperProvider>
          <Portal>
            ...
            >
              ...
              <Txt fontFamily={fonts.OL} size={16} color={colors.blue} marginBottom={10}>{t('Please log in here or press OK to hide the dialog.')}</Txt>
              ...
              {txtError && <Txt fontFamily={fonts.OL} color={colors.red} marginTop={20}>{'* '}{t(txtError)}</Txt>}
